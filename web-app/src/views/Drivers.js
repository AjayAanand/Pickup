...
export default function Users() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (rowData) =>
        rowData.tslImage ? (
          <button
            onClick={() => {
              onClick(rowData, "tslImage");
            }}
          >
            <img alt="tslImage" src={rowData.tslImage} style={{ width: 100 }} />
          </button>
        ) : null,
    },
    {
      title: titles.p_endoursmen_front_image,
      field: "p_endoursmenImageFront",
      cellStyle: { textAlign: "center" },
      render: (rowData) =>
        rowData.p_endoursmenImageFront ? (
          <button
            onClick={() => {
              onClick(rowData, "p_endoursmenImageFront");
            }}
          >
            <img
              alt="p_endoursmenImageFront"
              src={rowData.p_endoursmenImageFront}
              style={{ width: 100 }}
            />
          </button>
        ) : null,
    ...
    {
      title: titles.p_endoursmen_back_image,
      field: "p_endoursmenImageBack",
      cellStyle: { textAlign: "center" },
      render: (rowData) =>
        rowData.p_endoursmenImage ? (
          <button
            onClick={() => {
              onClick(rowData, "p_endoursmenImageBack");
            }}
          >
            <img
              alt="p_endoursmenImageBack"
              src={rowData.p_endoursmenImageBack}
              style={{ width: 100 }}
            />
          </button>
        ) : null,
    },
    {
      ...
      render: (rowData) =>
        rowData.cofImage ? (
          <button
            onClick={() => {
              onClick(rowData, "cofImage");
            }}
          >
            <img alt="cofImage" src={rowData.cofImage} style={{ width: 100 }} />
          </button>
        ) : null,
    },
    {
      title: titles.vehicle_registration_image,
      field: "vehicleRegistraionImage",
      cellStyle: { textAlign: "center" },
      render: (rowData) =>
        rowData.vehicleRegistraionImage ? (
          <button
            onClick={() => {
              onClick(rowData, "vehicleRegistraionImage");
            }}
          >
            <img
              alt="vehicleRegistraionImage"
              src={rowData.vehicleRegistraionImage}
              style={{ width: 100 }}
            />
          </button>
        ) : null,
    ...
    {
      title: titles.vehicle_insurance_image,
      field: "vehicleInsuranceImage",
      cellStyle: { textAlign: "center" },
      render: (rowData) =>
        rowData.vehicleInsuranceImage ? (
          <button
            onClick={() => {
              onClick(rowData, "vehicleInsuranceImage");
            }}
          >
            <img
              alt="vehicleInsuranceImage"
              src={rowData.vehicleInsuranceImage}
              style={{ width: 100 }}
            />
          </button>
        ) : null,
    ...
    {
      title: titles.airport_access_card_image,
      field: "airportAccessCardImage",
      cellStyle: { textAlign: "center" },
      render: (rowData) =>
        rowData.airportAccessCardImage ? (
          <button
            onClick={() => {
              onClick(rowData, "airportAccessCardImage");
            }}
          >
            <img
              alt="License"
              src={rowData.airportAccessCardImage}
              style={{ width: 100 }}
            />
          </button>
        ) : null,
